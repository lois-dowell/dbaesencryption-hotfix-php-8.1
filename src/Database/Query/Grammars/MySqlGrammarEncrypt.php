...
namespace Codiant\DBAESEncrypt\Database\Query\Grammars;

use Illuminate\Support\Str;
use Illuminate\Database\Query\Builder;
use Illuminate\Database\Query\JsonExpression;
use Codiant\DBAESEncrypt\Database\GrammarEncrypt;
...
class MySqlGrammarEncrypt extends GrammarEncrypt
{
    ...
    public function compileSelect(Builder $query)
    {
        ...
        if($query instanceof \Codiant\DBAESEncrypt\Database\Query\BuilderEncrypt) {
